...
- A student currently in secondary school to early university (14-23)
- An EU member state citizen
- Surface-level knowledge of how the EU actually works
- "I know I'm supposed to vote but honestly I'm not sure how any of this actually works or why it matters for my life."

Behaviors:

- Short attention span, prefers visual, interactive formats over walls of text
- Relates better to concepts when framed around their country or region eg. “how did this MEP vote on issues affecting Poland?" rather than abstract EU-wide statistics.”
- Likes to see/track their current progress through visual indicators

Core Needs/User Stories:
- As a student in a low-turnout country, I want to understand why EU elections affect my daily life so that I feel voting is worth my time
- As someone who struggles with Parliament concepts, I want the app to give me more Parliament lessons before moving on so that I’m not lost when harder topics build on them. 
...
- As a student, I want lessons personalized to my country and interests so that the information feels relevant to my own experiences and future

### Teacher

Bio:
- Secondary school or university teacher
- Social studies, history, civics
- "I want my students to actually care about the EU, but I can't spend hours building materials from scratch when I have three other subjects to prepare for."

Behaviors:
- Plans in weekly/unit blocks
- Monitor class-level progress, not just individual
- Comfortable customising module order/content, but wants reasonable defaults
